...
def story_post():
   ...
   story_info = db.story.find_one({"number": payload["number"]})
   return render_template('story_post.html',me_info=me_info, mentor_info=mentor_info, mentorinfo_info=mentorinfo_info, story_info=story_info)
